package test.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    private boolean validateRequest(HttpSession session, HttpServletRequest request) throws SpartanAccessDeniedException {
        if (!sessionValidation.checkIgnoreURL(request)) {
    ...
    @Pointcut("execution(* test.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* test.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* test.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* test.app.server.service..*..*(..))")
    protected void allOperation() {
    }

    @Pointcut("execution(* test.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* test.app.server.service..get*(..))")
